...
<div class="container-fluid">
      ...
      <div class="row row-offcanvas row-offcanvas-left">
        ...
        <div class="col-sm-9 col-md-10 main">
          ...
          <form role="form" id="form" method="post" action="<c:url value="/admin/recipe/save"/>"  enctype="multipart/form-data">
              <h1>Dados básicos da receita</h1>
              <div>
                <div class="form-group">
                  <label for="inputName">Nome</label>
                  <input type="text" class="form-control" name="recipe.title" id="inputName" placeholder="Nome da receita">
                </div>
                <div class="form-group">
                  <label for="inputRendimento">Rendimento</label>
                  <input type="text" class="form-control" name="recipe.yield" id="inputRendimento" placeholder="Quantas porções rende">
                </div>
                <div class="form-group">
                  <label for="inputDuracao">Duração</label>
                  <input type="text" class="form-control" name="recipe.duration" id="inputDuracao" placeholder="Tempo que leva">
                </div>
                <div class="form-group">
                  <label for="inputAutor">Autor</label>
                  <input type="text" class="form-control" name="recipe.author" id="inputAutor" placeholder="Autor da receita">
                </div>
                <div class="form-group">
                    <label for="inputImage">Imagem</label>
                    <input type="file" class="form-control" name="imagem" id="inputImage"/>
                </div>
              </div>
              <h1>Ingredientes</h1>
              <div>
                  <div id="stepIngredients">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="recipe.ingredients" id="txtAreaIngs" rows="3"></textarea>
                      </div>
                  </div>
              </div>
              ...
              <div>
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="recipe.howToCook" id="txtAreaHowTo" rows="3"></textarea>
                  </div>
