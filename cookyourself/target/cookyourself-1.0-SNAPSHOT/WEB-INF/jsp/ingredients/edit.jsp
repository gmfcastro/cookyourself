...
<div class="container-fluid">
      ...
      <div class="row row-offcanvas row-offcanvas-left">
        ...
        <div class="col-sm-9 col-md-10 main">
          ...
          <input type="text" name="ingredient.id" value="${ingredient.id}" hidden>
              
          <div class="form-group">
            <label for="inputName">Nome</label>
            <input type="text" class="form-control" name="ingredient.name" value="${ingredient.name}" id="inputName" placeholder="Nome do ingrediente">
          </div>
              
          <div class="form-group">
            <label for="txtAreaDesc">Descrição</label>
            <textarea class="form-control" name="ingredient.description" id="txtAreaDesc" rows="3">${ingredient.description}</textarea>
          </div>
